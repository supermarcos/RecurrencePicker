...
package com.example.calendarview.recurrencepicker;
...
//    }
    ...
    public void onClick(View v) {
        if (mEndDateTextView == v) {
        	Toast.makeText(getActivity(), "here should be shown a datepicker dialog or something...", Toast.LENGTH_LONG).show();
